...
if(OPENGLES2CHR_gl_LIBRARY)
    ...
    install(TARGETS opengles2chr EXPORT "OgreTargetsDebug")
    install(TARGETS opengles2chr EXPORT "OgreTargetsRelWithDebInfo")
    install(TARGETS opengles2chr EXPORT "OgreTargetsRelease")
